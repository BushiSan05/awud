(function () {
    const COUNTRIES = [
        ['us', 'United States', ['usa', 'united states', 'united states of america', 'america']], ['ca', 'Canada', ['canada']], ['mx', 'Mexico', ['mexico']], ['br', 'Brazil', ['brazil', 'brasil']], ['ar', 'Argentina', ['argentina']], ['gb', 'United Kingdom', ['uk', 'united kingdom', 'great britain', 'britain', 'england']], ['fr', 'France', ['france']], ['de', 'Germany', ['germany', 'deutschland']], ['it', 'Italy', ['italy']], ['es', 'Spain', ['spain']], ['pt', 'Portugal', ['portugal']], ['nl', 'Netherlands', ['netherlands', 'holland']], ['be', 'Belgium', ['belgium']], ['ch', 'Switzerland', ['switzerland']], ['at', 'Austria', ['austria']], ['se', 'Sweden', ['sweden']], ['no', 'Norway', ['norway']], ['dk', 'Denmark', ['denmark']], ['fi', 'Finland', ['finland']], ['pl', 'Poland', ['poland']], ['gr', 'Greece', ['greece']], ['tr', 'Turkey', ['turkey', 'turkiye']], ['ru', 'Russia', ['russia']], ['ua', 'Ukraine', ['ukraine']], ['ie', 'Ireland', ['ireland']], ['is', 'Iceland', ['iceland']], ['jp', 'Japan', ['japan']], ['cn', 'China', ['china']], ['kr', 'South Korea', ['south korea', 'korea']], ['in', 'India', ['india']], ['id', 'Indonesia', ['indonesia']], ['th', 'Thailand', ['thailand']], ['vn', 'Vietnam', ['vietnam']], ['ph', 'Philippines', ['philippines']], ['au', 'Australia', ['australia']], ['nz', 'New Zealand', ['new zealand']], ['eg', 'Egypt', ['egypt']], ['za', 'South Africa', ['south africa']], ['ng', 'Nigeria', ['nigeria']], ['ke', 'Kenya', ['kenya']], ['ma', 'Morocco', ['morocco']], ['sa', 'Saudi Arabia', ['saudi arabia', 'saudi']], ['ae', 'United Arab Emirates', ['uae', 'united arab emirates', 'emirates']], ['il', 'Israel', ['israel']], ['co', 'Colombia', ['colombia']], ['pe', 'Peru', ['peru']], ['cl', 'Chile', ['chile']], ['cu', 'Cuba', ['cuba']], ['jm', 'Jamaica', ['jamaica']], ['pk', 'Pakistan', ['pakistan']]
    ].map(([code, name, aliases]) => ({ code, name, aliases }));

    const ANIMALS = [
        ['🦁', 'Lion', ['lion']], ['🐯', 'Tiger', ['tiger']], ['🐘', 'Elephant', ['elephant']], ['🦒', 'Giraffe', ['giraffe']], ['🦓', 'Zebra', ['zebra']], ['🐼', 'Panda', ['panda', 'giant panda']], ['🐨', 'Koala', ['koala']], ['🦘', 'Kangaroo', ['kangaroo']], ['🐒', 'Monkey', ['monkey']], ['🦍', 'Gorilla', ['gorilla']], ['🐻', 'Bear', ['bear', 'grizzly bear', 'brown bear']], ['🦊', 'Fox', ['fox']], ['🐺', 'Wolf', ['wolf']], ['🐶', 'Dog', ['dog', 'puppy']], ['🐱', 'Cat', ['cat', 'kitten']], ['🐰', 'Rabbit', ['rabbit', 'bunny']], ['🐴', 'Horse', ['horse']], ['🐮', 'Cow', ['cow', 'cattle']], ['🐷', 'Pig', ['pig', 'hog']], ['🐑', 'Sheep', ['sheep']], ['🐐', 'Goat', ['goat']], ['🦌', 'Deer', ['deer']], ['🐫', 'Camel', ['camel']], ['🦉', 'Owl', ['owl']], ['🦅', 'Eagle', ['eagle']], ['🐧', 'Penguin', ['penguin']], ['🦩', 'Flamingo', ['flamingo']], ['🦚', 'Peacock', ['peacock']], ['🦜', 'Parrot', ['parrot']], ['🐬', 'Dolphin', ['dolphin']], ['🐳', 'Whale', ['whale']], ['🦈', 'Shark', ['shark']], ['🐙', 'Octopus', ['octopus']], ['🐢', 'Turtle', ['turtle', 'tortoise']], ['🐍', 'Snake', ['snake']], ['🐊', 'Crocodile', ['crocodile', 'alligator']], ['🐸', 'Frog', ['frog']], ['🐿️', 'Squirrel', ['squirrel']], ['🦔', 'Hedgehog', ['hedgehog']], ['🦏', 'Rhinoceros', ['rhino', 'rhinoceros']], ['🦛', 'Hippopotamus', ['hippo', 'hippopotamus']]
    ].map(([emoji, name, aliases]) => ({ emoji, name, aliases }));

    const MODES = {
        flags: { brandWord: 'FLAG', eyebrow: 'Voice \u00b7 Geography \u00b7 Against the clock', sub: 'A flag appears. You say the country. Five seconds on the clock.', rule1: "A flag is shown. Say the country's name out loud.", rule2: 'You have 5 seconds per flag before the call is missed.', placeholder: 'Say the country name\u2026', typePlaceholder: 'Type the country name\u2026', items: COUNTRIES, hsKey: 'flagcall_high_score_flags_v1' },
        animals: { brandWord: 'WILD', eyebrow: 'Voice \u00b7 Wildlife \u00b7 Against the clock', sub: 'A silhouette appears. You say the animal. Five seconds on the clock.', rule1: "A silhouette appears. Say the animal's name out loud.", rule2: 'You have 5 seconds per creature before the call is missed.', placeholder: 'Say the animal name\u2026', typePlaceholder: 'Type the animal name\u2026', items: ANIMALS, hsKey: 'flagcall_high_score_animals_v1' }
    };
    ...
    function applyModeText() { const cfg = MODES[currentMode]; brandWordEl.textContent = cfg.brandWord; eyebrowEl.textContent = cfg.eyebrow; subEl.textContent = cfg.sub; rulesList.children[0].innerHTML = '<span class="num">01</span> ' + cfg.rule1; rulesList.children[1].innerHTML = '<span class="num">02</span> ' + cfg.rule2; transcriptPlaceholder.textContent = cfg.placeholder; typeInput.placeholder = cfg.typePlaceholder; if (speechSupported) micStatus.textContent = 'Microphone ready. Tap start and speak clearly for each ' + (currentMode === 'animals' ? 'animal.' : 'flag.'); tabFlags.classList.toggle('active', currentMode === 'flags'); tabAnimals.classList.toggle('active', currentMode === 'animals'); }
    ...
    applyModeText(); updateAudioToggle(); loadHighScore(); setupSpeech();
})();